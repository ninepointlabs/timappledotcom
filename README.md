...
<img src="assets/npl-mark.svg" width="130" alt="Nine Point Labs nine-point star" />

# Nine Point Labs

**I build small, useful things.**

<a href="https://ninepointlabs.com"><img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=19&pause=1200&color=0F6B6E&center=true&vCenter=true&width=720&lines=Ruby+%E2%80%A2+Go+%E2%80%A2+QML+%E2%80%A2+Flutter+%E2%80%A2+Rust;Terminal+tools+that+earn+their+keep.;Omarchy+plugins+for+a+desktop+I+actually+like.;Nostr+infrastructure%2C+self-custodied.;A+dad+in+East+Texas+with+a+workshop." alt="Typing intro" /></a>
...
<br /><sub>`QML` · `Nostr` · [site](https://github.com/ninepointlabs/omostrich-website)</sub>
...
<br /><sub>`JavaScript` · `MCP` · `nostrdb`</sub>
...
<br /><sub>`Rails 8` · `SQLite/WAL` · `Solid Queue`</sub>
...
| Plugin | What it does | ⭐ |
|:--|:--|:--|
| [**barkeep**](https://github.com/ninepointlabs/barkeep) | Tends your bar — arrange, pin, update and remove shell plugins from one overlay | [![](https://img.shields.io/github/stars/ninepointlabs/barkeep?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/barkeep/stargazers) |
| [**omarchy-spotify**](https://github.com/ninepointlabs/omarchy-spotify) | Cover-art chip, now-playing panel, search, playlists, podcasts, headless player | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-spotify?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-spotify/stargazers) |
| [**omarchy-fastmail-calendar**](https://github.com/ninepointlabs/omarchy-fastmail-calendar) | Native CalDAV calendar — Day/Week/Month/Year, day detail, add events | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-fastmail-calendar?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-fastmail-calendar/stargazers) |
| [**omarchy-fastmail**](https://github.com/ninepointlabs/omarchy-fastmail) | Live unread mail from every folder, via `fm-cli` | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-fastmail?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-fastmail/stargazers) |
| [**omarchy-theme-rotate**](https://github.com/ninepointlabs/omarchy-theme-rotate) | Randomize your theme on demand or auto-rotate on a schedule | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-theme-rotate?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-theme-rotate/stargazers) |
| [**omarchy-ring-cameras**](https://github.com/ninepointlabs/omarchy-ring-cameras) | Ring cameras in the bar — live view, snapshots, history, motion alerts | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-ring-cameras?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-ring-cameras/stargazers) |
| [**omarchy-upcoming**](https://github.com/ninepointlabs/omarchy-upcoming) | TVmaze watchlist and next-episode dates | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-upcoming?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-upcoming/stargazers) |
| [**omarchy-hermes-chat**](https://github.com/ninepointlabs/omarchy-hermes-chat) | Fire a quick message at my local Hermes agent without opening the app | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-hermes-chat?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-hermes-chat/stargazers) |
| [**omarchy-hey-calendar**](https://github.com/ninepointlabs/omarchy-hey-calendar) | The HEY-CLI-backed predecessor to the CalDAV one | [![](https://img.shields.io/github/stars/ninepointlabs/omarchy-hey-calendar?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/omarchy-hey-calendar/stargazers) |

<details>
<summary><b>🕹️ …and the ones that exist purely for fun</b></summary>
...
|:--|:--|:--|
| [**fm-cli**](https://github.com/ninepointlabs/fm-cli) [![](https://img.shields.io/github/stars/ninepointlabs/fm-cli?style=flat&label=&labelColor=23272B&color=0F6B6E)](https://github.com/ninepointlabs/fm-cli/stargazers) | `Go` | Minimalist TUI email client for Fastmail over **JMAP** |
...
<img src="https://skillicons.dev/icons?i=ruby,rails,go,rust,dart,flutter,sqlite,js,html,css,tailwind,git,linux,neovim,vscode&theme=dark" alt="Tech stack" />

</div>

<div align="center">

![Arch](https://img.shields.io/badge/Arch%20Linux-0F6B6E?style=flat-square&logo=archlinux&logoColor=FAF6EF&labelColor=23272B)
![Hyprland](https://img.shields.io/badge/Hyprland-0F6B6E?style=flat-square&logo=hyprland&logoColor=FAF6EF&labelColor=23272B)
![Neovim](https://img.shields.io/badge/Neovim-0F6B6E?style=flat-square&logo=neovim&logoColor=FAF6EF&labelColor=23272B)
![Obsidian](https://img.shields.io/badge/Obsidian-0F6B6E?style=flat-square&logo=obsidian&logoColor=FAF6EF&labelColor=23272B)
![Railway](https://img.shields.io/badge/Railway-0F6B6E?style=flat-square&logo=railway&logoColor=FAF6EF&labelColor=23272B)
![SQLite](https://img.shields.io/badge/SQLite%20%2B%20WAL-0F6B6E?style=flat-square&logo=sqlite&logoColor=FAF6EF&labelColor=23272B)
...
```mermaid
graph TD
    T["👤 Tim<br/><i>final approval on everything</i>"]
    H["⚙️ Hermes<br/><i>desktop host · cron schedules</i>"]
    T <--> H
    H --> TC["✍️ Trent Crimm<br/>marketing drafts<br/><b>never publishes</b>"]
    H --> HG["🎩 Higgins<br/>GitHub notification triage"]
    H --> KL["🔧 Keeley<br/>systems + troubleshooting"]
    H --> CL["📓 Claude<br/>Obsidian vault"]
    TC -.->|draft| T
    HG -.->|triage| T
    KL -.->|report| T
    CL -.->|notes| T
...
<picture>
  ...
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=ninepointlabs&theme=github" height="210" alt="profile-details" />
</picture>
...
<picture>
  ...
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=ninepointlabs&theme=github" height="200" alt="repos-per-language" />
</picture>
<picture>
  ...
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=ninepointlabs&theme=github" height="200" alt="most-commit-language" />
</picture>
...
<picture>
  ...
  <img src="https://streak-stats.demolab.com?user=ninepointlabs&hide_border=true&background=FAF6EF&stroke=0F6B6E&ring=0F6B6E&fire=0F6B6E&currStreakLabel=0F6B6E&sideLabels=23272B&currStreakNum=23272B&sideNums=23272B&dates=565D63" height="180" alt="Contribution streak" />
</picture>
...
<sub>Linux user who will absolutely judge your OS choice, then offer to help you switch distros anyway.</sub>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:4fd1c5,100:0f6b6e&height=110&section=footer" alt="" />
